...
export const interviewerPrompt = ChatPromptTemplate.fromMessages([
    ...
    ["system", "3. Present this business case: 'A luxury hotel chain is experiencing declining profits despite stable occupancy rates. What might be causing this issue and how would you approach solving it?'"],
